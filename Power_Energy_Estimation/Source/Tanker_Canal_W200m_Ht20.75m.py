...
"""Something that consumes energy.
    ...
    - h_B1: Position of the centre of the transverse area in percentage of mean draught (default value: 0.2)
    - A_T1: Transverse area of the transom in percentage of B*T (default value: 0.2)
    - D_s: Propeller diameter (If none, calculated)
"""

data_moteur = {"P_installed": 17500.0,
               "L_w": 3.0 ,
               "C_year":2020,
               "Typvessel":'Tanker',
               "c_stern":10,
...
plt.grid(True)
plt.legend()
plt.title('Tanker: L$_s$ = 260 m, B$_s$ = 48 m, T$_s$ = 17 m')
